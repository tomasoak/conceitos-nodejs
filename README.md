...
Essa aplicação armazena repositórios do emu portfólio, que permiti a criação, listagem, atualização e remoção dos repositórios, e além disso permitir que os repositórios possam receber "likes".
...
- **`PUT /repositories/:id`**: Altera atributos do repositório com o `id` presente nos parâmetros da rota;
